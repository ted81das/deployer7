...
'serveravatar' => [
    'api_url' => env('SERVERAVATAR_API_BASE_URL', 'https://api.serveravatar.com'),
    'token' => env('SERVERAVATAR_API_KEY'),
    'org_id' => env('SERVERAVATAR_ORG_ID'),
    'server_id' => env('SERVERAVATAR_SERVER_NUMBER'),
    'git_provider_id' => env('SERVERAVATAR_GIT_PROVIDER_ID', 228),
    'server_hostname' =>   env('SERVERAVATAR_PHPSECLIB_HOSTNAME_IP','172.236.110.221'),
],
