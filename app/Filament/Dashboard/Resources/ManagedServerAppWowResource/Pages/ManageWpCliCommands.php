...
class ManageWpCliCommands extends Page
{
    protected static string $resource = ManagedServerAppWowResource::class;

    protected static string $view = 'filament.dashboard.resources.managed-server-app-wow-resource.pages.manage-wp-cli-commands';
}
