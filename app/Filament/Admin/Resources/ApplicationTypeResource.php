...
use App\Filament\Admin\Resources\ApplicationTypeResource\Pages;
use App\Filament\Admin\Resources\ApplicationTypeResource\RelationManagers;
        ...
        return $form
            ->schema([
                ...
                Forms\Components\TextInput::make('type')
                    ->required(),
                Forms\Components\TextInput::make('server_control_panel_type')
                    ->required(),
                Forms\Components\TextInput::make('class_type')
                    ->required(),
                Forms\Components\TextInput::make('cli_framework')
                    ->required(),
                Forms\Components\TextInput::make('repo_type')
                    ->required(),
                ...
                Forms\Components\TextInput::make('repo_url')
                    ->maxLength(255),
                Forms\Components\TextInput::make('repo_username')
                    ->maxLength(255),
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                Tables\Columns\TextColumn::make('server_control_panel_type'),
                Tables\Columns\TextColumn::make('class_type'),
                Tables\Columns\TextColumn::make('cli_framework'),
                Tables\Columns\TextColumn::make('repo_type'),
                ...
                Tables\Columns\TextColumn::make('repo_url')
                    ->searchable(),
                Tables\Columns\TextColumn::make('repo_username')
                    ->searchable(),
                Tables\Columns\TextColumn::make('repository_name')
                    ->searchable(),
                Tables\Columns\TextColumn::make('repo_branch')
                    ->searchable(),
